...
## read datasets
train = fread("E://Machine Learning/My practice/Kaggle_AV projects/bigmart sale_Analytics vidhya/Train_bm.csv")
test = fread("E://Machine Learning/My practice/Kaggle_AV projects/bigmart sale_Analytics vidhya/Test_bm.csv")
